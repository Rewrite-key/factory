...
<head>
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      window.open("workbench/index.do", "workareaFrame");

      $("#logoutBtn").click(function () {
        //发送同步请求
        window.location.href="settings/permission/admin/logout.do";
      });
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
  <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
    猎人谷 &nbsp;<span style="font-size: 12px;">信息数据库页面</span></div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
  ...
  <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
    ...
    <ul id="no1" class="nav nav-pills nav-stacked">
      <li class="liClass"><a href="workbench/employee.do" target="workareaFrame"><span
              class="glyphicon glyphicon-home"></span> 员工信息</a></li>
      <li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span
              class="glyphicon glyphicon-tag"></span> 客户管理</a></li>
      <li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span
              class="glyphicon glyphicon-time"></span> 物料管理</a></li>
      <li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span
              class="glyphicon glyphicon-user"></span> 库存管理</a></li>
      <li class="liClass"><a href="workbench/activity/index.do" target="workareaFrame"><span
              class="glyphicon glyphicon-play-circle"></span> 工艺管理</a></li>
      <li class="liClass"><a href="clue/index.html" target="workareaFrame"><span
              class="glyphicon glyphicon-search"></span> 生产管理</a></li>
      <li class="liClass"><a href="customer/index.html" target="workareaFrame"><span
              class="glyphicon glyphicon-user"></span> 出货外发</a></li>
      <li class="liClass"><a href="contacts/index.html" target="workareaFrame"><span
              class="glyphicon glyphicon-earphone"></span> 模具管理</a></li>
      <li class="liClass"><a href="transaction/index.html" target="workareaFrame"><span
              class="glyphicon glyphicon-usd"></span> 数据中心</a></li>
    </ul>
